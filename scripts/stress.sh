...
jbang run@hyperfoil -PLOAD_DURATION=20s -PWARMUP_DURATION=0s -PWARMUP_PAUSE_DURATION=0s ${thisdir}/perf-lab/load-tests/load-test-fixed-threads-read-all.hf.yml
